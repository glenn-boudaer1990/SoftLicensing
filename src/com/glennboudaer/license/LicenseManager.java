package com.glennboudaer.license;
...
import com.glennboudaer.enums.KeyStatus;
...
public class LicenseManager
{
		...
		try
		{
			...
			if (LICENSE.getLicenseType().equals(LicenseType.TRIAL))
			{
				...
				JOptionPane.showMessageDialog(null,
						"This is a trial version of the software.  You have " + val + " days remaining in your trial.",
						"Trial Version", JOptionPane.INFORMATION_MESSAGE);
	...
	public void createLicense(String name, String email, String authCode, LicenseType licenseType, Date expiration,
